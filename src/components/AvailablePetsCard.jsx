...
const AvailablePetsCard = ({pet}) => {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-md hover:shadow-orange-100 duration-500 overflow-hidden hover:shadow-lg transition ">
      {/* Image & Age badge */}
      ...
      <div className="p-4 flex flex-col flex-1">
        ...
        <div className=" flex justify-end items-end">
          <button className="mt-4 inline-flex items-center bg-orange-400 text-white px-4 py-1 sm:py-2 rounded-full text-sm font-medium hover:bg-[#FFB22C] transition cursor-pointer">
